...
export const houses: House[] = [
  {
    ...
    character: "From Chicago came Lord Galvin, founder of the Realm, loyal son of the Bears and first keeper of the Council’s laws. He built the table at which the Ten Lords gather, then took the commissioner’s seat at its head and assured them all that the arrangement was impartial.",
    lore: ["In his hands rests the Shifting Rulebook, an ancient volume whose pages possess the remarkable ability to clarify themselves precisely when their keeper requires clarification. Thus he became the Whisperer of Rules: warden of the waiver wire, guardian of procedure and the only Lord who can amend an argument while it is still being made.", "Yet the Commissioner’s court has never felt whole since Baron Chin—his brother and old co-conspirator—departed the Council. Some say Galvin lost a brother. Others say he lost his most reliable trading partner. The Realm records only that chaos remains a ladder, and Lord Galvin is usually standing nearest the next rung."],
  ...
  },
  {
    ...
    character: "Lord Keys has long stood among the Realm’s most consistent competitors, season after season advancing within reach of glory—yet still without the Crown. He is the Protector of the Crown, the King’s Hand and keeper of the prize he has never been permitted to call his own.",
  ...
  },
  {
    ...
    character: "Lord Richey came later to the Council than many of the Ten, yet entered as though the argument had been waiting specifically for him. Vocal, certain and instinctively contrary, he bears two banners that were never meant to share the same hall.",
    lore: ["He is sworn somehow to both Seattle and San Francisco despite the ancient inconvenience of their rivalry. Storm and ocean contest one half of the Divided Shield; crimson sun and golden towers claim the other. Neither half appears pleased, and their bearer refuses to surrender either.", "So House Richey has made contradiction into inheritance. He chooses both sides, disputes the premise and marches beneath colors trusted by neither camp. Even the Exalted Charlatan is welcomed into his court, arms folded in borrowed grandeur, as proof that confidence has never required consensus."], chronicle: "THE TWO BANNERS", easterEgg: "PICK A TEAM.",
  },
  {
