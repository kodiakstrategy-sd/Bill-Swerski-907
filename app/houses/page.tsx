...
export default function HousesPage() {
  return <div className="page-wrap houses-commune"><PageHero eyebrow="The Council of the 907" title="The House Commune" intro="Ten banners. Two ancient divisions. An unreasonable quantity of documented grievance." />
